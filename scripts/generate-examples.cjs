...
// Paths
const RUST_EXAMPLES_DIR = '/Users/mulgogi/src/parsanol/parsanol-rs/examples';
const RUBY_EXAMPLES_DIR = '/Users/mulgogi/src/parsanol/parsanol-ruby/example';
...
function main() {
  ...
  // Write manifest JSON
  const manifestPath = path.join(__dirname, '../src/data/examples-manifest.json');
